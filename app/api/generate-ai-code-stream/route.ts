...
`;
        ...
        console.log(`[generate-ai-code-stream] Using OpenRouter model: ${model}`);

        // Make streaming API call via OpenRouter
...
It's better to have 3 complete files than 10 incomplete files.`
          ...
          // We use XML tags for package detection instead of tool/function calling
        };
